...
public class MainActivity extends AppCompatActivity {
    ...
    // поля
    private Button buttonWallpaper, buttonDrywall, buttonElectricalWiring, buttonPaint, buttonHeatingRadiators, buttonMoneyCalculation; // кнопки
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonMoneyCalculation = findViewById(R.id.buttonMoneyCalculation);
        ...
        buttonMoneyCalculation.setOnClickListener(listener);
    }
        ...
        public void onClick(View view) {
            switch (view.getId()) {
                ...
                case R.id.buttonPaint:
                    break;
                case R.id.buttonMoneyCalculation:
                    Intent intentMoneyActivity = new Intent(getApplicationContext(), CalculationMoneyActivity.class); // создание намерения переключения в активность калькулятора обоев
                    startActivity(intentMoneyActivity);
                    break;
            }
        }
    };
